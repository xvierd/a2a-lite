...
/**
 * Hello Agent - A2A protocol v1.0 "from scratch" (Java)
 *
...
public class HelloAgent {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hello Agent - A2A v1.0 from scratch (Java)");
        System.out.println("=".repeat(60));
    ...
    private static ObjectNode createAgentCard() {
        ...
        card.put("description", "A simple greeting agent (A2A v1.0 from scratch)");
